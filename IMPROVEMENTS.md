...
2. Extract the duplicated directory-resolution helper (§3).
3. Delete the dead inline-assertion path and align README/CLAUDE.md (§2) — largest cleanup for the smallest risk, since nothing depends on it.
